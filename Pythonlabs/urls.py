...
from python import views as user_views
...
urlpatterns = [
    ...
    path('first/', user_views.first, name="first"),
    path('login/', auth_views.LoginView.as_view(template_name='users/login.html'), name="Login"),
    path('password_reset/', user_views.MyPasswordResetView.as_view(template_name='users/password_reset.html'), name="password_reset"),
